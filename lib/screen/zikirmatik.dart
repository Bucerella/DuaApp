...
class _ZikirMatikState extends State<ZikirMatik> {
  ...
  List zikirler = ["Allahû Ekber","Lâ İlâhe İllallah","Subhan'Allāh","Tövbe Estağfurullah","Kelime-i Tevhid","Kelime-i Şehadet","Salavat-ı Şerif"];
  List zikirSayac = [0,0,0,0,0,0,0];

  _loadSavedData() async{
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    for(int i = 0 ; i < zikirSayac.length;i++){
      if(sharedPreferences.getInt("zikir$i")!=null && sharedPreferences.getInt("zikir$i")!=0){
        setState(() {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage("images/zikir-detay.jpg",),fit: BoxFit.cover),
        ),
        child: Column(
            ...
            Material(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text("${selectedItem}",style: TextStyle(color: Colors.white,fontSize: 20),),
                    SizedBox(height: 20,),
                    Text("${zikirSayac[selectedZikirItem]}",style: TextStyle(color: Colors.white,fontSize: 20),),
                  ],
                ),
              ),
            ),
                ...
                Material(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Icon(FontAwesomeIcons.undo,color: Colors.white,size: 30,),
                    ),
                  ),
                ),
              ],
                ...
                children: zikirler.map((zikir){
                  return  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          Icon(FontAwesomeIcons.readme,color: Colors.white,),
                          SizedBox(height: 10,),
                          Text("${zikir}",style: TextStyle(color: Colors.white),)
                        ],
                      ),
                    ),
                  );
